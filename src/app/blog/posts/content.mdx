...
Replace the `public/images/logo-avat.png` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
